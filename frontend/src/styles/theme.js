...
export const flowbiteTheme = {
  ...
  button: {
    ...
    color: {
      ...
      blue: 'bg-primary-600 text-white hover:bg-primary-700 focus:ring-primary-200 dark:bg-primary-500 dark:hover:bg-primary-600 dark:focus:ring-primary-300',
      secondary:
    ...
    field: {
      ...
      input: {
        ...
        colors: {
          ...
          info: 'border-primary-300 bg-neutral-900/50 text-neutral-100 placeholder-neutral-400 focus:border-primary-300 focus:ring-primary-300 dark:border-neutral-500 dark:bg-neutral-900/70 dark:text-neutral-100',
        },
      },
    },
  },
